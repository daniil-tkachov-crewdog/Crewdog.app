...
export const LINKEDIN_FINDER_DEFAULTS = {
  ...
  finder_extra_factor_hints:
    "company, seniority, industry, skills, certifications, language, current vs past employer",
  ...
  finder_compress_instructions: [
    ...
    "- When nothing passed verification, say so in one line and suggest which criterion to relax.",
  ].join("\n"),
};
